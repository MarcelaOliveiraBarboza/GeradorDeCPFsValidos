...
var GeraCPF = /*#__PURE__*/function () {
  ...
  return GeraCPF;
}(); // a ideia é gerar 9 digitos aleatórios, e apartir deles, serão gerados os 2 primeiros digitos, sendo um cpf válido
...
var ValidaCPF = /*#__PURE__*/function () {
  function ValidaCPF(cpfEnviado) {
    ...
    Object.defineProperty(this, 'cpfLimpo', {
      ...
      writable: false,
      configurable: false,
      value: cpfEnviado.replace(/\D+/g, '') //tudo oq não for numero, remove
  ...
  _createClass(ValidaCPF, [{
    ...
    value: function éSequencia() {
      return this.cpfLimpo.charAt(0).repeat(11) === this.cpfLimpo; // ele vai repetir o primeiro caractere do cpfLimpo 11 vezez e se for igual ao cpfLimpo impresso é uma sequencia de numeros iguais
    }
  }, {
    key: "geraNovoCpf",
    value: function geraNovoCpf() {
      var cpfSemDigitos = this.cpfLimpo.slice(0, -2); //com o cpfLimpo, pegou ele sem os dois ultimos digitos

      var digito1 = ValidaCPF.geraDigito(cpfSemDigitos);
      var digito2 = ValidaCPF.geraDigito(cpfSemDigitos + digito1); //ambos com o nome da class ValidaCPF pois o geraDigito é Stacic

      this.novoCpf = cpfSemDigitos + digito1 + digito2; // conferir se o cpf sem os dois ultimos digitos somado com os dois digitos feito na conta irão bater com o cpf limpo
    }
  }, {
    key: "valida",
    value: function valida() {
      if (!this.cpfLimpo) return false; // se não tiver cpflimpo, retorna falso

      if (typeof this.cpfLimpo !== "string") return false; // se for diferente de string, retorne false

      if (this.cpfLimpo.length !== 11) return false; // se a quant for diferente de 11, falso

      if (this.éSequencia()) return false; // se houver uma sequencia, retorne false
    ...
    value: function geraDigito(cpfSemDigitos) {
      ...
      try {
        for (_iterator.s(); !(_step = _iterator.n()).done;) {
          ...
          total += reverso * Number(stringNumerica); //convertida e numero
      ...
      return digito <= 9 ? String(digito) : '0'; // se o digito for menor q 9, retorna o digito, caso for maior retorne 0;
    }
  }]);
...
// Module
___CSS_LOADER_EXPORT___.push([module.id, ":root{\r\n    --primary-color: rgb(13, 106, 134);\r\n    --primary-color-darker: rgb(9, 48, 56);\r\n\r\n}\r\n\r\n*{\r\n    box-sizing: border-box;\r\n    outline: 0;\r\n}\r\n\r\nbody{\r\n    padding: 0;\r\n    margin: 0;\r\n    background: var(--primary-color);\r\n    font-family: 'Open Sans', sans-serif;\r\n    font-size: 1.3em;\r\n    line-height: 1.5em;\r\n}\r\n\r\n.container{\r\n    max-width: 640px;\r\n    margin: 50px auto; /*conteudo centralizado*/\r\n    background: #fff;\r\n    padding: 20px;\r\n    border-radius: 10px; /*arredonda as bordas*/\r\n}\r\n\r\nform input, form label, form button{\r\n    display: block;\r\n    width: 100%;\r\n    margin-bottom: 10px;\r\n}\r\n\r\nform input{\r\n    font-size: 24px;\r\n    height: 50px;\r\n    padding: 0 20px;\r\n}\r\n\r\nform input:focus{\r\n    outline: 1px solid var(--primary-color);\r\n} /*cor ao redor da borda do input quando clicar*/\r\n\r\nform button{\r\n    border: none;\r\n    background: var(--primary-color);\r\n    color: white;\r\n    font-size: 18px;\r\n    font-weight: 700;\r\n    height: 50px;\r\n    cursor: pointer; /*mãozinha quando fica encima do botão*/\r\n    margin-top: 30px;\r\n}\r\n\r\nform button:hover{\r\n    background: var(--primary-color-darker); /*muda de cor quando o mouse passa por cima*/\r\n}\r\n\r\n.container h1 {\r\n    text-align: center;\r\n    margin-bottom: 40px;\r\n}\r\n\r\n.cpf-gerado{\r\n    font-size:2em ;\r\n    color: var(--primary-color);\r\n    text-align: center;\r\n    font-weight: bold;\r\n    margin-bottom: 40px;\r\n    letter-spacing: 3px;\r\n}\r\n", "",{"version":3,"sources":["webpack://./src/assets/css/styles.css"],"names":[],"mappings":"AAEA;IACI,kCAAkC;IAClC,sCAAsC;;AAE1C;;AAEA;IACI,sBAAsB;IACtB,UAAU;AACd;;AAEA;IACI,UAAU;IACV,SAAS;IACT,gCAAgC;IAChC,oCAAoC;IACpC,gBAAgB;IAChB,kBAAkB;AACtB;;AAEA;IACI,gBAAgB;IAChB,iBAAiB,EAAE,wBAAwB;IAC3C,gBAAgB;IAChB,aAAa;IACb,mBAAmB,EAAE,sBAAsB;AAC/C;;AAEA;IACI,cAAc;IACd,WAAW;IACX,mBAAmB;AACvB;;AAEA;IACI,eAAe;IACf,YAAY;IACZ,eAAe;AACnB;;AAEA;IACI,uCAAuC;AAC3C,EAAE,+CAA+C;;AAEjD;IACI,YAAY;IACZ,gCAAgC;IAChC,YAAY;IACZ,eAAe;IACf,gBAAgB;IAChB,YAAY;IACZ,eAAe,EAAE,uCAAuC;IACxD,gBAAgB;AACpB;;AAEA;IACI,uCAAuC,EAAE,4CAA4C;AACzF;;AAEA;IACI,kBAAkB;IAClB,mBAAmB;AACvB;;AAEA;IACI,cAAc;IACd,2BAA2B;IAC3B,kBAAkB;IAClB,iBAAiB;IACjB,mBAAmB;IACnB,mBAAmB;AACvB","sourcesContent":["@import url('https://fonts.googleapis.com/css2?family=Open+Sans:wght@400;700&display=swap');\r\n\r\n:root{\r\n    --primary-color: rgb(13, 106, 134);\r\n    --primary-color-darker: rgb(9, 48, 56);\r\n\r\n}\r\n\r\n*{\r\n    box-sizing: border-box;\r\n    outline: 0;\r\n}\r\n\r\nbody{\r\n    padding: 0;\r\n    margin: 0;\r\n    background: var(--primary-color);\r\n    font-family: 'Open Sans', sans-serif;\r\n    font-size: 1.3em;\r\n    line-height: 1.5em;\r\n}\r\n\r\n.container{\r\n    max-width: 640px;\r\n    margin: 50px auto; /*conteudo centralizado*/\r\n    background: #fff;\r\n    padding: 20px;\r\n    border-radius: 10px; /*arredonda as bordas*/\r\n}\r\n\r\nform input, form label, form button{\r\n    display: block;\r\n    width: 100%;\r\n    margin-bottom: 10px;\r\n}\r\n\r\nform input{\r\n    font-size: 24px;\r\n    height: 50px;\r\n    padding: 0 20px;\r\n}\r\n\r\nform input:focus{\r\n    outline: 1px solid var(--primary-color);\r\n} /*cor ao redor da borda do input quando clicar*/\r\n\r\nform button{\r\n    border: none;\r\n    background: var(--primary-color);\r\n    color: white;\r\n    font-size: 18px;\r\n    font-weight: 700;\r\n    height: 50px;\r\n    cursor: pointer; /*mãozinha quando fica encima do botão*/\r\n    margin-top: 30px;\r\n}\r\n\r\nform button:hover{\r\n    background: var(--primary-color-darker); /*muda de cor quando o mouse passa por cima*/\r\n}\r\n\r\n.container h1 {\r\n    text-align: center;\r\n    margin-bottom: 40px;\r\n}\r\n\r\n.cpf-gerado{\r\n    font-size:2em ;\r\n    color: var(--primary-color);\r\n    text-align: center;\r\n    font-weight: bold;\r\n    margin-bottom: 40px;\r\n    letter-spacing: 3px;\r\n}\r\n"],"sourceRoot":""}]);
// Exports
...
/* harmony import */ var _assets_css_styles_css__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./assets/css/styles.css */ "./src/assets/css/styles.css");
 ...
 //função que auto-se chama, se auto-executa:
